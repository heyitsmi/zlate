...
Zlate uses a freemium model:

| Feature | Free | Premium |
|---------|------|---------|
| AI Engines | Gemini, DeepSeek | All 5 engines |
| Tones | Neutral only | All 7 tones |
| History | 5 items (local) | Unlimited + cloud sync |

Premium license available at [zlate.app](https://zlate.app)

### Backend

License validation backend is maintained in a separate repository:
- **Repository**: [zlate-licence-system](https://github.com/your-username/zlate-licence-system)
